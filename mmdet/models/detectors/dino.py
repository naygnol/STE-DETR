...
class DINO(DeformableDETR):
    ...
    def forward_decoder(self,
        ...
        """
        inter_states_cls, inter_states_box, references = self.decoder(
            query=query,
            value=memory,
        ...
        decoder_outputs_dict = dict(
            hidden_states_cls=inter_states_cls, hidden_states_box=inter_states_box, references=list(references))
