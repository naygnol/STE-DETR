...
class HungarianAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        if num_gts == 0 or num_preds == 0:
            indices = [torch.tensor([], dtype=torch.int64),torch.tensor([], dtype=torch.int64)]
            ...
            return AssignResult(
                ...
                max_overlaps=None,
                labels=assigned_labels), indices
        ...
        ##
        matched_col_inds_indices, ind = torch.as_tensor(matched_col_inds, dtype=torch.int64).sort()
        matched_row_inds_indices = torch.tensor(matched_row_inds, dtype=torch.int64)[ind].view(-1)
        indices = [matched_row_inds_indices, matched_col_inds_indices]
